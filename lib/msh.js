...
exports.init = function(callback, errCallback) {
    ...
    queue.allOk = function () {
        ...
        if (asyncTasks.length != queue.length) httpErrs = true;
...
function createUrlTemplater(action, queue) {
    ...
    return  function(asyncCallback) {
            ...
            lastHttpAction = getLastHttpAction(action, queue);
            nextHttpAction = getNextHttpAction(action, queue);
            processorTemplate = action.processor(lastHttpAction.response);
